...
query_rate_limiter = RateLimiter(max_requests=10, time_window=60)  # 10 requests per minute
history_rate_limiter = RateLimiter(max_requests=5, time_window=60)  # 5 requests per minute
